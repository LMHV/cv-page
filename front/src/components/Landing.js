        ...
        <div className="first-container">
            ...
            <div className="right-side">
                <div className="buttons-container">
                    <button onClick={event => window.location.href='https://github.com/LMHV'} className="svg-button">
                    ...
                    <button onClick={event => window.location.href='https://www.instagram.com/lucho_herrero/'} className="svg-button">
                    ...
                    <button className="svg-button">
                        <svg onClick={event => window.location.href='https://www.linkedin.com/in/luis-herrero-8755b1237/'} className="svg-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
